...
exports.sig_bug_line_split = void 0;
function sig_bug_line_split(line) {
    // clean the data
    ...
    if (!has_within_range)
        console.log("form id for has not within range: ", form_id);
}
exports.sig_bug_line_split = sig_bug_line_split;
//# sourceMappingURL=sigBug.js.map